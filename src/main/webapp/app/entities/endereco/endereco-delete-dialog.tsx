...
export const EnderecoDeleteDialog = (props: RouteComponentProps<{ id: string }>) => {
  ...
  return (
    <Modal isOpen toggle={handleClose}>
      ...
      <ModalBody id="kitlivreApp.endereco.delete.question">Are you sure you want to delete this Endereco?</ModalBody>
      <ModalFooter>
